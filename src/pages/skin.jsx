    ...
    useEffect(() => {
        let fetchData = async () => {
            try {
                ...
                console.log('Error in fetch skin Data:', error)
            }
        }
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/MOISTURIZERS-_-SUNSCREENS---LP.jpg?v=1733729251&width=1600" alt="" className='opacity-50' />
            </div>
