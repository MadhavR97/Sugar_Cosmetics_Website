        ...
        let fetchData = async () => {
            try {
                ...
                let a = result.filter((el) => {
                    return el.category == 'lips'
                })
                setLips(a)
                setLoader(false)
            }
            catch (error) {
                console.log('Error in fetch data of Lips:', error)
            }
        }
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/Partner-in-Shine-Transferproof-Lip-Gloss-LP1600x400.jpg?v=1735043047&width=1600" alt="" className='opacity-80' />
            </div>
            <div className='w-full h-screen flex'>
                <div className='w-[25%] h-screen p-15 rounded-r-2xl'>
