        ...
        let fetchData = async () => {
            try {
                ...
                let a = result.filter((el) => {
                    return el.category == 'eyes'
                })
                setEyes(a)
                setLoader(false)
            }
            catch (error) {
                console.log('Error in fetch Eyes Data:', error)
            }
        }
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/Eyes-1600x400-withCTA.jpg?v=1733394028&width=1600" alt="" className='opacity-50' />
            </div>
            <div className='w-full h-screen flex'>
                <div className='w-[25%] h-full p-15 rounded-r-2xl'>
