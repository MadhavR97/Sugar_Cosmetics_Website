...
function Gifting() {
    ...
    // Fetch Data
    let [gifting, setGifting] = useState([])
    ...
    useEffect(() => {
        let fetchData = async () => {
            try {
                ...
                console.log('Error in fetch Gifting Data:', error)
            }
        }
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/Welcome-offer-10--Off-LP1600x400_1.jpg?v=1733728614&width=1600" alt="" className='opacity-50' />
            </div>
