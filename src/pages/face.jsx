        ...
        let fetchData = async () => {
            try {
                ...
                let a = result.filter((el) => {
                    return el.category == 'face'
                })
                setFace(a)
                setLoader(false)
            }
            catch (error) {
                console.log('Error in fetch Face Data:', error)
            }
        }
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/Face-1600x400-withCTA.jpg?v=1733394095&width=1600" alt="" className='opacity-50' />
            </div>
