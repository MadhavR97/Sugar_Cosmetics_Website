    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/Nail-lacquer-homepage-banner.gif?v=1733728533&width=1600" alt="" className='opacity-50' />
            </div>
