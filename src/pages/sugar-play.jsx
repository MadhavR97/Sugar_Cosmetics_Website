...
function SugarPlay() {
    ...
    // Fetch Data
    let [sugarPlay, setSugarPlay] = useState([])
        ...
        let fetchData = async () => {
            try {
                ...
                let a = result.filter((el) => {
                    return el.category == 'sugar play'
                })
                setSugarPlay(a)
                setLoader(false)
            }
            catch (error) {
                console.log('Error in fetch Sugar Play Data:', error)
            }
        }
    ...
    let filterChange = (e, value) => {
        if (e.target.checked == true) {
            if (value == 'B500') {
                setSugarPlay(sugarPlay.filter((el) => {
                    return el.price < 500
                }))
            }
            else if (value == 'A500') {
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full bg-black'>
                <img src="https://www.sugarcosmetics.com/cdn/shop/collections/SUGAR-PLAY-LIP-OIL---Banner-_-Ads-URGENT_1920x453_3_4994cc3e-6f8f-4836-8457-0ec99216e318.jpg?v=1735629456&width=1800" alt="" className='opacity-50' />
            </div>
